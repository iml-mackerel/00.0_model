...
#do.peel(year.peel=1, year=2024, fit=fit, name="fitBase")# abort!
do.peel(year.peel=2, year=2024, fit=fit, name="fitBase")
do.peel(year.peel=3, year=2024, fit=fit, name="fitBase")
do.peel(year.peel=4, year=2024, fit=fit, name="fitBase")
#do.peel(year.peel=5, year=2024, fit=fit, name="fitBase")# abort! trycatch does not work on this
do.peel(year.peel=6, year=2024, fit=fit, name="fitBase")
do.peel(year.peel=7, year=2024, fit=fit, name="fitBase")
...
source("Rscripts/2024/surplus/ssbplot0.R")
